	...
	private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) 
			 {
				 ...
				 g->Clear(this->BackColor);//Отчищает всю поверхность рисования и закрашивает её цветом "this->BackColor"
			 }
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) 
			 {
				 InitializeComponent();
				 g = this->CreateGraphics();//CreateGraphics() задаёт объект Graphics для элемента управления
				 g->Clear(this->BackColor);//Отчищает всю поверхность рисования и закрашивает её цветом "this->BackColor"
