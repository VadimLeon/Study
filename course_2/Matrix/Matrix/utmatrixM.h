...
//TMatrix<ValType> TMatrix<ValType>::operator*(const TMatrix<ValType> &mt)
//{
//	TMatrix<ValType> res(mt.GetSize());
//	if(this->pVector.GetSize() == mt.pVector.GetSize())
//	{
//		res = TMatrix<ValType>(this->pVector.GetSize());
//	}
//
//	for(int i = 0; i < this->pVector.GetSize(); i++)
//	{
//		for(int j = 0; j < mt.pVector.GetSize(); j++)
//		{
//			ValType c = 0;
//
//			for(int k = 0; k < j; k++)
//			{
//				c = c + ((this->pVector[i][k]) * (mt.pVector[k][j]));
//				res.pVector[i][j] = c;
//			}
//		}
//	}
